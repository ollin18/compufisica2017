...
find /usr./ -perm 777
find /var/ -name "*.tar"
touch ps -u usuario  MisProcesos.prs  #Creamos un archivo que contenga todos los procesos de mi usuario
...
chmod u+rwx,g+r,o+rwx todos.prm  #Cambiamos permisos le damos permiso al usuario y a los otros de ejecución, lectura y escritura y al grupo de lectura
